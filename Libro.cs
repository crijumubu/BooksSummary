...
namespace Books_Sumaary
{
    public static class Libro
    {
        ...
        {
            string rutaSinopsis = @"C:\Users\Administrador\source\repos\Books Summary\Extra\Sinopsis.txt";
        ...
        {
            string rutaDescarga = @"C:\Users\Administrador\source\repos\Books Summary\Extra\Rutas de descarga.txt";
